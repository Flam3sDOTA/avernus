		...
		for i=0, 8 do
			...
			if item and item:GetAbilityName() == "item_roshan_key" then
				...
				for _, enemy in pairs(enemies) do
					...
					if enemy:GetUnitName() == "npc_dota_roshan_gate_2" then
						EmitSoundOn("Building_Generic.Destruction", enemy)
						activator:RemoveItem(roshangate2key)
						...
						UTIL_Remove( enemy )
						local hAnimGate = CreateUnitByName( "npc_dota_roshan_gate_2_anim", vPos, false, nil, nil, DOTA_TEAM_BADGUYS )
